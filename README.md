...
This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).  <!-- refactored contrib call -->
...
<!-- updated: logic -->
<!-- // filter: add_switch — processFilter -->
