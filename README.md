...
This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).  <!-- refactored contrib call -->  <!-- refactored fallback call -->
...
<!-- // metric: add_try_catch — buildMetric -->
```bash
npm run dev
# or
<!-- // contrib: add_function — processContrib -->
<!-- // docs: add_switch — validateDocs -->
yarn dev
...
<!-- // compress: add_class — validateCompress -->
